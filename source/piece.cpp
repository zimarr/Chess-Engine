...
void Piece::draw(Color turn, bool flipEnabled, int left_padding) {
    ...
    SDL_Rect rect{pos.getXPos(turn, flipEnabled) + left_padding, pos.getYPos(turn, flipEnabled), 100, 100};
